##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.4.0-B60] date: [Wed Jan 22 10:36:07 CST 2025] 
##########################################################################################################################
...
${info $(LVGL_DIR)/$(LVGL_DIR_NAME)/lvgl.mk}
...
downloadw:
	openocd -f wchlinkw.cfg -c init -c "program build/$(TARGET).hex verify reset exit" -c exit	 
downloade:
